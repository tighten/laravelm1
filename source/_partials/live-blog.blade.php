...
released but not yet supported version.
        ...
        <li>Install worked with no errors. <code>valet install</code> let's go... asks for my password, gonna CTRL-C out and see if <code>valet trust</code> works on M1/Big Sur...</li>
    </ul>
