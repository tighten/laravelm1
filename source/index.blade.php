...
{{--             <div class="flex my-10">
    ...
    <div>
        ...
        <table class="border border-gray-400">
            <tr><td class="py-2 pl-3 pr-4 text-right">Haven't tested yet</td><td class="py-2 pr-3">@status('unsure')</td></tr>
            <tr><td class="py-2 pl-3 pr-4 text-right">Doesn't work as of testing</td><td class="py-2 pr-3">@status('no')</td></tr>
            <tr><td class="py-2 pl-3 pr-4 text-right">Works, through Rosetta 2</td><td class="py-2 pr-3">@status('rosetta')</td></tr>
            <tr><td class="py-2 pl-3 pr-4 text-right">Works natively</td><td class="py-2 pr-3">@status('yes')</td></tr>
        </table>
    </div>
